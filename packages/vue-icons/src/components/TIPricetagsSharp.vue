...
<path fill-rule="evenodd" clip-rule="evenodd" d="M288 16L0 304L176 480L464 192V16H288ZM368 144C350.327 144 336 129.673 336 112C336 94.3269 350.327 80 368 80C385.673 80 400 94.3269 400 112C400 120.487 396.629 128.626 390.627 134.627C384.626 140.629 376.487 144 368 144ZM480 208V64H512V224L242 496L216.9 471.1L480 208Z" fill="currentColor"/>
</svg>
</template>
