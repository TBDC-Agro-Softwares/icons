...
<path fill-rule="evenodd" clip-rule="evenodd" d="M416 48H96C60.6538 48 32 76.6538 32 112V400C32 435.346 60.6538 464 96 464H416C451.346 464 480 435.346 480 400V112C480 76.6538 451.346 48 416 48ZM440 144H72C67.5817 144 64 140.418 64 136V112C64.0494 94.3474 78.3474 80.0494 96 80H416C433.653 80.0494 447.951 94.3474 448 112V136C448 140.418 444.418 144 440 144Z" fill="currentColor"/>
</svg>
</template>
