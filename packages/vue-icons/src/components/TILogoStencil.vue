...
<path d="M428.8 64H232.2L125.87 177.93H322.62L428.8 64Z" fill="currentColor"/>
<path d="M512 199H106.61L0 313H405.39L512 199Z" fill="currentColor"/>
<path d="M188.8 334.07H386.13L279.47 448H83.2L188.8 334.07Z" fill="currentColor"/>
</svg>
</template>
