...
<path fill-rule="evenodd" clip-rule="evenodd" d="M336 157.63L272 93.63V177H240V93.63L176 157.63L153.37 135L256 32.37L358.63 135L336 157.63ZM240 177H92C85.3726 177 80 182.373 80 189V469C80 475.627 85.3726 481 92 481H420C426.627 481 432 475.627 432 469V189C432 182.373 426.627 177 420 177H272V338H240V177Z" fill="currentColor"/>
</svg>
</template>
