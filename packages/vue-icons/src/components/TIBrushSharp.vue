...
<path fill-rule="evenodd" clip-rule="evenodd" d="M416 32L480 96L236 356L172 292L416 32ZM76 388.57C76 350.63 105.48 320 142 320C178.52 320 208 350.63 208 388.57C208 439.09 168.62 480 120 480C86.78 480 52.24 462.17 32 434.29C45 434.29 76 414 76 388.57Z" fill="currentColor"/>
</svg>
</template>
