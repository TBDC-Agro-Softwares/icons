...
<path fill-rule="evenodd" clip-rule="evenodd" d="M382 0H130C120.059 0 112 8.05887 112 18V494C112 503.941 120.059 512 130 512H382C391.941 512 400 503.941 400 494V18C400 8.05887 391.941 0 382 0ZM148 448V64H364V448H148Z" fill="currentColor"/>
</svg>
</template>
