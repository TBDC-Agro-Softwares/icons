...
<path fill-rule="evenodd" clip-rule="evenodd" d="M312 56C312 86.9279 286.928 112 256 112C225.072 112 200 86.9279 200 56C200 25.0721 225.072 0 256 0C286.928 0 312 25.0721 312 56ZM48 180V128H464V180H320L352 505.02L301 512L279.67 320H232.65L211 512L160 505.13L192 180H48Z" fill="currentColor"/>
</svg>
</template>
