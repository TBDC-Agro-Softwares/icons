...
<path fill-rule="evenodd" clip-rule="evenodd" d="M48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256C464 141.13 370.87 48 256 48C141.13 48 48 141.13 48 256ZM146 344C146 275.87 168.67 206.86 265.17 206.86V152L366 248L265.17 344V289.14C198.48 289.14 173.85 308.43 146 344Z" fill="currentColor"/>
</svg>
</template>
