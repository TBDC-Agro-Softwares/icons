...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 464C141.31 464 48 370.69 48 256C48 141.31 141.31 48 256 48C370.69 48 464 141.31 464 256C464 370.69 370.69 464 256 464Z" fill="currentColor"/>
</svg>
</template>
