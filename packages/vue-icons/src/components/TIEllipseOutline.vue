...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.125 48 48 141.125 48 256C48 370.875 141.125 464 256 464C370.875 464 464 370.875 464 256C464 141.125 370.875 48 256 48ZM256 80C353.202 80 432 158.798 432 256C432 353.202 353.202 432 256 432C158.798 432 80 353.202 80 256C80 158.798 158.798 80 256 80Z" fill="currentColor"/>
</svg>
</template>
