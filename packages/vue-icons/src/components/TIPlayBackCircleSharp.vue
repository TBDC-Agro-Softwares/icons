...
<path fill-rule="evenodd" clip-rule="evenodd" d="M48 256C48 370.69 141.31 464 256 464C370.69 464 464 370.69 464 256C464 141.31 370.69 48 256 48C141.31 48 48 141.31 48 256ZM111.47 256L248 168V240.16L368 167.68V344.13L248 271.81V343.25L111.47 256Z" fill="currentColor"/>
</svg>
</template>
