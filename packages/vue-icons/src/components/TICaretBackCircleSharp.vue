...
<path fill-rule="evenodd" clip-rule="evenodd" d="M48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256C464 141.13 370.87 48 256 48C141.13 48 48 141.13 48 256ZM300 364.27L169.91 256L300 147.73V364.27Z" fill="currentColor"/>
</svg>
</template>
