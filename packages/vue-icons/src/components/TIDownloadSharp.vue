...
<path fill-rule="evenodd" clip-rule="evenodd" d="M272 32H240V160H92C85.3726 160 80 165.373 80 172V468C80 474.627 85.3726 480 92 480H420C426.627 480 432 474.627 432 468V172C432 165.373 426.627 160 420 160H272V32ZM272 160V307.37L336 243.37L358.63 266L256 368.63L153.37 266L176 243.37L240 307.37V160H272Z" fill="currentColor"/>
</svg>
</template>
