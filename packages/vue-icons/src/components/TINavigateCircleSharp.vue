...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.177 48.1268 48.1268 141.177 48 256C48 370.68 141.31 464 256 464C370.823 463.873 463.873 370.823 464 256C464 141.31 370.69 48 256 48ZM248 409V264H104H103L362 149.89L248 409Z" fill="currentColor"/>
</svg>
</template>
