...
<path fill-rule="evenodd" clip-rule="evenodd" d="M464 256C464 141.13 370.87 48 256 48C141.13 48 48 141.13 48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256ZM240 336.09L303.58 272H154V240H303.58L240 175.91L262.71 153.37L364.54 256L262.7 358.63L240 336.09Z" fill="currentColor"/>
</svg>
</template>
