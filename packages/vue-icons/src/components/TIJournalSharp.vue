...
<path fill-rule="evenodd" clip-rule="evenodd" d="M104 32H290V480H104C90.7452 480 80 469.255 80 456V56C80 42.7452 90.7452 32 104 32ZM350 32H408C421.255 32 432 42.7452 432 56V456C432 469.255 421.255 480 408 480H350V32Z" fill="currentColor"/>
</svg>
</template>
