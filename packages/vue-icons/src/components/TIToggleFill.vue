...
<path fill-rule="evenodd" clip-rule="evenodd" d="M368 112H144C64.6 112 0 176.6 0 256C0 335.4 64.6 400 144 400H368C447.4 400 512 335.4 512 256C512 176.6 447.4 112 368 112ZM368 368C306.144 368 256 317.856 256 256C256 194.144 306.144 144 368 144C429.856 144 480 194.144 480 256C479.934 317.828 429.828 367.934 368 368Z" fill="currentColor"/>
</svg>
</template>
