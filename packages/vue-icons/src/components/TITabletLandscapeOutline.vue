...
<path fill-rule="evenodd" clip-rule="evenodd" d="M0 128L0 384C0 419.346 28.6538 448 64 448H448C483.346 448 512 419.346 512 384V128C512 92.6538 483.346 64 448 64H64C28.6538 64 0 92.6538 0 128ZM32 384L32 128C32 110.327 46.3269 96 64 96H448C465.673 96 480 110.327 480 128V384C480 401.673 465.673 416 448 416H64C46.3269 416 32 401.673 32 384Z" fill="currentColor"/>
</svg>
</template>
