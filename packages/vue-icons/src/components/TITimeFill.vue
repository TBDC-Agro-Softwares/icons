...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.13 48 48 141.13 48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256C464 141.13 370.87 48 256 48ZM352 288H256C247.163 288 240 280.837 240 272V128C240 119.163 247.163 112 256 112C264.837 112 272 119.163 272 128V256H352C360.837 256 368 263.163 368 272C368 280.837 360.837 288 352 288Z" fill="currentColor"/>
</svg>
</template>
