...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.13 48 48 141.13 48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256C464 141.13 370.87 48 256 48ZM246.83 289.14V344L146 248L246.83 152V206.86C343.33 206.86 366 275.86 366 344C338.15 308.43 313.52 289.14 246.83 289.14Z" fill="currentColor"/>
</svg>
</template>
