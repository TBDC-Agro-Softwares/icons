...
<path fill-rule="evenodd" clip-rule="evenodd" d="M24 384H488C492.418 384 496 380.418 496 376V88C496 83.5817 492.418 80 488 80H24C19.5817 80 16 83.5817 16 88V376C16 380.418 19.5817 384 24 384ZM116 400C113.791 400 112 401.791 112 404V428C112 430.209 113.791 432 116 432H396C398.209 432 400 430.209 400 428V404C400 401.791 398.209 400 396 400H116Z" fill="currentColor"/>
</svg>
</template>
