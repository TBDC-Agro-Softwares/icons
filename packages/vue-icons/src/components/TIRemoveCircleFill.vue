...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.31 48 48 141.31 48 256C48 370.69 141.31 464 256 464C370.69 464 464 370.69 464 256C464 141.31 370.69 48 256 48ZM336 272H176C167.163 272 160 264.837 160 256C160 247.163 167.163 240 176 240H336C344.837 240 352 247.163 352 256C352 264.837 344.837 272 336 272Z" fill="currentColor"/>
</svg>
</template>
