...
<path fill-rule="evenodd" clip-rule="evenodd" d="M448 64H64L32 256V448H480V256L448 64ZM436 256H320C320 291.346 291.346 320 256 320C220.654 320 192 291.346 192 256H76L98 106H414L436 256Z" fill="currentColor"/>
</svg>
</template>
