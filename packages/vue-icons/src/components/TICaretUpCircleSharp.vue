...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.13 48 48 141.13 48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256C464 141.13 370.87 48 256 48ZM147.73 300L256 169.91L364.27 300H147.73Z" fill="currentColor"/>
</svg>
</template>
