...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 32C167.67 32 96 96.51 96 176C96 304 256 480 256 480C256 480 416 304 416 176C416 96.51 344.33 32 256 32ZM256 256C220.654 256 192 227.346 192 192C192 156.654 220.654 128 256 128C291.346 128 320 156.654 320 192C319.961 227.33 291.33 255.961 256 256Z" fill="currentColor"/>
</svg>
</template>
