...
<path fill-rule="evenodd" clip-rule="evenodd" d="M190.06 414L353.18 274.22C358.498 269.66 361.558 263.005 361.558 256C361.558 248.995 358.498 242.34 353.18 237.78L190.06 98C174.49 84.66 150.44 95.72 150.44 116.22V395.82C150.44 416.32 174.49 427.38 190.06 414Z" fill="currentColor"/>
</svg>
</template>
