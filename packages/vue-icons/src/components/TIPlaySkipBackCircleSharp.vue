...
<path fill-rule="evenodd" clip-rule="evenodd" d="M48 256C48 370.69 141.31 464 256 464C370.69 464 464 370.69 464 256C464 141.31 370.69 48 256 48C141.31 48 48 141.31 48 256ZM176 176H208V245L336 167.47V344.37L208 267V336H176V176Z" fill="currentColor"/>
</svg>
</template>
