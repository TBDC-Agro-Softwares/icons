...
<path fill-rule="evenodd" clip-rule="evenodd" d="M426 16H273H239H86C47.3 16 16 47.3 16 86V426C16 464.7 47.3 496 86 496H239H273H426C464.7 496 496 464.7 496 426V86C496 47.3 464.7 16 426 16ZM86 462C66.1 462 50 445.9 50 426V86C50 66.1 66.1 50 86 50H239V462H86ZM462 426C462 445.9 445.9 462 426 462H273V50H426C445.9 50 462 66.1 462 86V426Z" fill="currentColor"/>
</svg>
</template>
