...
<path fill-rule="evenodd" clip-rule="evenodd" d="M224 128C224 145.673 238.327 160 256 160C264.487 160 272.626 156.629 278.627 150.627C284.629 144.626 288 136.487 288 128C288 110.327 273.673 96 256 96C238.327 96 224 110.327 224 128ZM280 200V376H345V416H167V376H240V240H176V200H280Z" fill="currentColor"/>
</svg>
</template>
