...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.31 48 48 141.31 48 256C48 370.69 141.31 464 256 464C370.69 464 464 370.69 464 256C464 141.31 370.69 48 256 48ZM276 367.91H236V327.91H276V367.91ZM272 304H240L234 144H278L272 304Z" fill="currentColor"/>
</svg>
</template>
