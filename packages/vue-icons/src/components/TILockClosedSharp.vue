...
<path fill-rule="evenodd" clip-rule="evenodd" d="M420 192H352V112C352 58.9807 309.019 16 256 16C202.981 16 160 58.9807 160 112V192H92C85.3726 192 80 197.373 80 204V484C80 490.627 85.3726 496 92 496H420C426.627 496 432 490.627 432 484V204C432 197.373 426.627 192 420 192ZM314 192H198V111.25C198 79.2175 223.967 53.25 256 53.25C288.033 53.25 314 79.2175 314 111.25V192Z" fill="currentColor"/>
</svg>
</template>
