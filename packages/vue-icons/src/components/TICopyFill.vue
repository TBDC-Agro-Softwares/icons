...
<path fill-rule="evenodd" clip-rule="evenodd" d="M395.88 80H160C115.817 80 80 115.817 80 160V395.88C51.2562 385.679 32.0368 358.5 32 328V104C32 64.2355 64.2355 32 104 32H328C358.5 32.0368 385.679 51.2562 395.88 80ZM184 480H408C447.764 480 480 447.764 480 408V184C480 144.235 447.764 112 408 112H184C144.235 112 112 144.235 112 184V408C112 447.764 144.235 480 184 480Z" fill="currentColor"/>
</svg>
</template>
