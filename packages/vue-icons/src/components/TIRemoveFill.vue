...
<path fill-rule="evenodd" clip-rule="evenodd" d="M400 240C408.837 240 416 247.163 416 256C416 264.731 409.006 271.829 400.315 271.997L400 272H112C103.163 272 96 264.837 96 256C96 247.269 102.994 240.171 111.685 240.003L112 240H400Z" fill="currentColor"/>
</svg>
</template>
