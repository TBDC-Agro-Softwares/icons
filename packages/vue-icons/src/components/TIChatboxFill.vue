...
<path fill-rule="evenodd" clip-rule="evenodd" d="M144 464C135.163 464 128 456.837 128 448V384H104C64.2538 383.956 32.0441 351.746 32 312V120C32.0441 80.2538 64.2538 48.0441 104 48H408C447.746 48.0441 479.956 80.2538 480 120V312C479.956 351.746 447.746 383.956 408 384H245.74L154.25 460.29C151.371 462.685 147.745 463.997 144 464Z" fill="currentColor"/>
</svg>
</template>
