...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.13 48 48 141.13 48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256C464 141.13 370.87 48 256 48ZM318.63 352L296 374.63L177.37 256L296 137.37L318.63 160L222.63 256L318.63 352Z" fill="currentColor"/>
</svg>
</template>
