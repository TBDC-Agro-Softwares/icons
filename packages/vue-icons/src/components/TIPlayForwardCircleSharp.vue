...
<path fill-rule="evenodd" clip-rule="evenodd" d="M256 48C141.31 48 48 141.31 48 256C48 370.69 141.31 464 256 464C370.69 464 464 370.69 464 256C464 141.31 370.69 48 256 48ZM264 343.25V271.81L144 344.13V167.71L264 240.19V168L400.53 256L264 343.25Z" fill="currentColor"/>
</svg>
</template>
