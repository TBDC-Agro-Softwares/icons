...
<path fill-rule="evenodd" clip-rule="evenodd" d="M88 80H424C454.928 80 480 105.072 480 136V162H32V136C32 105.072 57.0721 80 88 80ZM32 376C32 406.928 57.0721 432 88 432H424C454.928 432 480 406.928 480 376V222H32V376ZM98 300C98 283.431 111.431 270 128 270H176C192.569 270 206 283.431 206 300V320C206 336.569 192.569 350 176 350H128C111.431 350 98 336.569 98 320V300Z" fill="currentColor"/>
</svg>
</template>
