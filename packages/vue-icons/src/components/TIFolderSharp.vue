...
<path fill-rule="evenodd" clip-rule="evenodd" d="M468 96C483.464 96 496 108.536 496 124V176H16V92C16 76.536 28.536 64 44 64H164.84L212.84 96H468ZM44 448C28.536 448 16 435.464 16 420V208H496V420C496 435.464 483.464 448 468 448H44Z" fill="currentColor"/>
</svg>
</template>
