...
<path fill-rule="evenodd" clip-rule="evenodd" d="M312 56C312 86.9279 286.928 112 256 112C225.072 112 200 86.9279 200 56C200 25.0721 225.072 0 256 0C286.928 0 312 25.0721 312 56ZM144 160C144 142.327 158.327 128 176 128H336C353.673 128 368 142.327 368 160V320H320V192H312V512H260V328H252V512H200V192H192V320H144V160Z" fill="currentColor"/>
</svg>
</template>
