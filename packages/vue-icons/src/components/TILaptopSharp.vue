...
<path fill-rule="evenodd" clip-rule="evenodd" d="M477.29 400C479.08 396.253 480.006 392.152 480 388V108C480 92.536 467.464 80 452 80H60C44.536 80 32 92.536 32 108V388C31.9941 392.152 32.9202 396.253 34.71 400H0V432H512V400H477.29Z" fill="currentColor"/>
</svg>
</template>
