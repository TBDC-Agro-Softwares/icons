...
<path fill-rule="evenodd" clip-rule="evenodd" d="M128 464V384H56C42.7452 384 32 373.255 32 360V72C32 58.7452 42.7452 48 56 48H456C469.255 48 480 58.7452 480 72V360C480 373.255 469.255 384 456 384H245.74L128 464Z" fill="currentColor"/>
</svg>
</template>
