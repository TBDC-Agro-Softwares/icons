...
<path fill-rule="evenodd" clip-rule="evenodd" d="M144 32L68 108L138 178L32 280L208 464L360.8 315.7L416 304L144 32ZM168 148L128.4 107L144.28 91.11L184 132L168 148ZM352 419.84C352 368 416 320 416 320C416 320 480 368 480 419.84C480 453 451.33 480 416 480C380.67 480 352 453.12 352 419.84Z" fill="currentColor"/>
</svg>
</template>
