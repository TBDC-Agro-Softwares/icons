...
<path fill-rule="evenodd" clip-rule="evenodd" d="M232 400V136H112V400H232ZM88 64H424C437.255 64 448 74.7452 448 88V328C448 341.255 437.255 352 424 352H280V424C280 437.255 269.255 448 256 448H88C74.7452 448 64 437.255 64 424V88C64 74.7452 74.7452 64 88 64ZM280 136V304H400V136H280Z" fill="currentColor"/>
</svg>
</template>
