...
<path fill-rule="evenodd" clip-rule="evenodd" d="M336 208V128C336 119.163 328.837 112 320 112H32C23.1634 112 16 119.163 16 128V384C16 392.837 23.1634 400 32 400H320C328.837 400 336 392.837 336 384V304L496 400V112L336 208Z" fill="currentColor"/>
</svg>
</template>
