...
<path fill-rule="evenodd" clip-rule="evenodd" d="M464 256C464 141.13 370.87 48 256 48C141.13 48 48 141.13 48 256C48 370.87 141.13 464 256 464C370.87 464 464 370.87 464 256ZM212 147.73L342.09 256L212 364.27V147.73Z" fill="currentColor"/>
</svg>
</template>
