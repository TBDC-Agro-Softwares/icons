...
<path fill-rule="evenodd" clip-rule="evenodd" d="M400 227.47V288L448 352V400H64V352L112 288V227.47C112 156.76 139.12 95.61 208 80L216 32H296L304 80C372.64 95.61 400 157 400 227.47ZM329.3 432C316.561 461.131 287.795 479.968 256 480C224.205 479.968 195.439 461.131 182.7 432H329.3Z" fill="currentColor"/>
</svg>
</template>
