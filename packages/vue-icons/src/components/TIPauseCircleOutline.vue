...
<path fill-rule="evenodd" clip-rule="evenodd" d="M48 256C48 141.163 141.163 48 256 48C370.837 48 464 141.163 464 256C464 370.837 370.837 464 256 464C141.163 464 48 370.837 48 256ZM432 256C432 158.837 353.163 80 256 80C158.837 80 80 158.837 80 256C80 353.163 158.837 432 256 432C353.163 432 432 353.163 432 256ZM208 176C216.731 176 223.829 182.994 223.997 191.685L224 192V320C224 328.837 216.837 336 208 336C199.269 336 192.171 329.006 192.003 320.315L192 320V192C192 183.163 199.163 176 208 176ZM319.997 191.685C319.829 182.994 312.731 176 304 176C295.163 176 288 183.163 288 192V320L288.003 320.315C288.171 329.006 295.269 336 304 336C312.837 336 320 328.837 320 320V192L319.997 191.685Z" fill="currentColor"/>
</svg>
</template>
