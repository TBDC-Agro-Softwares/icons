import { defineComponent as o, computed as n, openBlock as a, createElementBlock as s, normalizeClass as r, normalizeStyle as d, createElementVNode as t } from "vue";
const u = /* @__PURE__ */ o({
  __name: "TIStampUnsolicited",
  props: {
    size: {
      type: String,
      default: "is-default",
  ...
  setup(e) {
    ...
    return (c, i) => (a(), s("svg", {
      ...
      t("path", {
        d: "M292.923 256C292.923 252.601 290.168 249.846 286.769 249.846H225.231L225.11 249.847C221.767 249.912 219.077 252.642 219.077 256C219.077 259.399 221.832 262.154 225.231 262.154H286.769L286.89 262.153C290.233 262.088 292.923 259.358 292.923 256Z",
        fill: "white"
      }, null, -1),
      t("path", {
        "fill-rule": "evenodd",
