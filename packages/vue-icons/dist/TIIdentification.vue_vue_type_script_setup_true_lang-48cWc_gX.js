...
const u = /* @__PURE__ */ o({
  ...
  setup(t) {
    ...
    return (d, l) => (a(), C("svg", {
      class: n(i.value),
      style: s(t.color ? `color: ${t.color} !important` : void 0),
      width: "512",
      height: "512",
      viewBox: "0 0 512 512",
      fill: "none",
