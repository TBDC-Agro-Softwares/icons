  ...
  setup(e) {
    ...
    return (p, t) => (a(), r("svg", {
      ...
      d("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
        d: "M456 48H56C42.7452 48 32 58.7452 32 72V360C32 373.255 42.7452 384 56 384H128V464L245.74 384H456C469.255 384 480 373.255 480 360V72C480 58.7452 469.255 48 456 48ZM160 248C142.327 248 128 233.673 128 216C128 198.327 142.327 184 160 184C177.673 184 192 198.327 192 216C192 233.673 177.673 248 160 248ZM256 248C238.327 248 224 233.673 224 216C224 198.327 238.327 184 256 184C273.673 184 288 198.327 288 216C288 233.673 273.673 248 256 248ZM352 248C334.327 248 320 233.673 320 216C320 198.327 334.327 184 352 184C369.673 184 384 198.327 384 216C384 233.673 369.673 248 352 248Z",
        fill: "currentColor"
      }, null, -1)
    ]), 6));
  }
