import { defineComponent as C, computed as s, openBlock as a, createElementBlock as n, normalizeClass as r, normalizeStyle as c, createElementVNode as i } from "vue";
const m = /* @__PURE__ */ C({
  __name: "TIStampPending",
  props: {
    size: {
      type: String,
      default: "is-default",
  ...
  setup(e) {
    ...
    return (d, l) => (a(), n("svg", {
      ...
      i("path", {
        d: "M301.857 249.243L263.757 211.143L193 281.9V320H231.1L301.857 249.243ZM211.143 300.043V286.436L261.943 235.636L274.643 249.243L223.843 300.043H211.143ZM270.107 204.793L276.457 198.443C283.714 191.186 295.507 191.186 301.857 198.443L314.557 211.143C321.814 218.4 321.814 229.286 314.557 236.543L308.207 242.893L270.107 204.793Z",
        fill: "white"
      }, null, -1)
    ]), 6));
  }
